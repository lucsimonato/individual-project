...
public  class AudioLoader: MonoBehaviour
{
    ...
    public void getAudiosForWell(int wellID){
        ...
        //Debug.Log("player prefs says I have "+ audios.Count +" audios for well with ID "+wellID);
    ...
    public void generateAudioCollections(){
        ...
        for(int i = 0;i<collections;i++){
            ...
            if(audioPosition[0] != "deleted"){
                ...
                GameObject sphere = Camera.main.GetComponent<MyCameraController>().assignCollectionToScene(i, newSpherePosition);
    ...
    private void getCollectionAudios(GameObject sphere){
        ...
        List<string> audios = new List<string>(tempString.Split('/'));
        audios.RemoveAt(audios.Count-1);
        //Debug.Log("player prefs says I have "+ audios.Count +" audios for collection with ID "+sphere.GetComponent<SphereCollectionBehaviour>().getID());
