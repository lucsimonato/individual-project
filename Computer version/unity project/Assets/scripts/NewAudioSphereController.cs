    ...
    IEnumerator recordNewAudio(){
        ...
        if(wellID!=-1){
            ...
            if(collectionID!=-1){
                ...
                int audiosInScene = Camera.main.GetComponent<MyCameraController>().getAudiosInScene();
                ...
                Camera.main.GetComponent<MyCameraController>().incrementAudiosInScene();
                PlayerPrefs.SetInt("AudiosInScene", audiosInScene+1);
                PlayerPrefs.Save();
            }else{
                Camera.main.GetComponent<MyCameraController>().enterPlaceMode(newAudio);
            }
        }
        transform.GetChild(0).GetComponent<TextMesh>().text = "+";
    }
