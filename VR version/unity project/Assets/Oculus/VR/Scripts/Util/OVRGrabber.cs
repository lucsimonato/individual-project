...
{
    //public TextMesh candidatesCount;
    ...
    [SerializeField] private GameObject m_collidersNotToIgnore;
    ...
    virtual public void Update()
    {
        ...
        //candidatesCount.text = m_grabCandidates.Count.ToString();
    }
    ...
    protected virtual void GrabBegin()
    {
        ...
        if (closestGrabbable != null)
        {
            ...
            else
            {
                ...
                //tentativo
                //m_grabbedObjectRotOff = m_grabbedObj.transform.rotation;
            }
    ...
    protected virtual void GrabVolumeEnable(bool enabled)
    {
        ...
        for (int i = 0; i < m_grabVolumes.Length; ++i)
        {
            ...
            grabVolume.enabled = m_grabVolumeEnabled;             //collider always remains enabled
        ...
        //m_grabCandidates.Clear();           //always clear grab candidates
    }
	...
	protected void SetPlayerIgnoreCollision(GameObject grabbable, bool ignore)
	{
		if (m_player != null)
		{
			...
			foreach (Collider c in colliders)
			{
                ...
                Collider[] collidersNotToIgnore = m_collidersNotToIgnore.GetComponentsInChildren<Collider>();
				foreach (Collider collide in collidersNotToIgnore)
				{
					Physics.IgnoreCollision(c, collide, false);
				}
			}
